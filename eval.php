...
<nav>
	...
	<table class="content-table">
		...
		<tbody>
		<tr>
	<td><input class="form-control" classtype='number' name='note' value='<?php echo $row[$colle];?>'></td>
	<td><textarea class="form-control" name="remarque" cols="50" rows="10"><?php echo $row[$reval];?></textarea></td>
		</tr>
	</tbody></table>
	<button name="save"  class="btn btn-outline-primary">Enregistrer</button>
</form>
